...
{{< figure src="/static/images/LSTM1.png" alt="LSTM" caption="Structure of LSTM" width="600" height="350"  >}}
...
{{< figure src="/static/images/LSTM2.png" alt="LSTM using Peepholes" width="700" height="400" >}}
...
{{< callout type="info" title="Equations" >}}
- $ f_t = \sigma (W_f \cdot [C_{t-1}, h_{t-1}, x_t] + b_f) $
- $ i_t = \sigma (W_i \cdot [C_{t-1}, h_{t-1}, x_t] + b_i) $
- $ o_t = \sigma (W_o [C_{t-1}, h_{t-1}, x_t] + b_o) $
{{< /callout>}}

{{< figure src="/static/images/LSTM3.png" alt="LSTM" caption="LSTM" width="350" height="200" >}}
...
{{< figure src="/static/images/LSTM4.png" alt="GRU" caption="GRU" width="650" height="320" >}}
